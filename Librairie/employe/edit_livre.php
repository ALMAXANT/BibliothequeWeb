...
if($_GET['Id_Livre']) {
    ...
    if (isset($_REQUEST['Titre'], $_REQUEST['Type_livre'], $_REQUEST['Nom_Auteur'], $_REQUEST['Prenom_Auteur'])){
        ...
        $Titre = mysqli_real_escape_string($conn, $Titre); 
         ...
         //requéte SQL
         $query = "UPDATE livre SET Titre = '$Titre', Type_livre = '$Type_livre' WHERE Id_Livre = {$Id_Livre}"; 
        
         $query = "UPDATE auteur SET Nom_Auteur = '$Nom_Auteur', Type_livre = '$Type_livre' WHERE Id_Livre = {$Id_Livre}"; 
